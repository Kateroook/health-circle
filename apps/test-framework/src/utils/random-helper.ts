  ...
  phone(country: 'ua' | 'us' | 'uk' | 'de' | 'pl' = 'ua') {
    const config = {
      ...
      us: {
        code: '+1',
        operators: [
          '201', '202', '212', '213', '312', // AT&T
          '310', '415', '424', '469', '512', // T-Mobile
          '614', '646', '702', '713', '818', // Verizon
        ],
        subscriberLength: 7,
      },
      uk: {
        code: '+44',
        operators: [
          '7400', '7500', '7700', '7800', // EE
          '7300', '7400',                  // O2
          '7900', '7800',                  // Vodafone UK
          '7700', '7600',                  // Three
        ],
        subscriberLength: 6,
      },
      ...
      pl: {
        code: '+48',
        operators: [
          '500', '501', '502', '503', // Orange PL
          '510', '511', '512', '513', // Play
          '600', '601', '602', '603', // T-Mobile PL
          '720', '721', '722', '723', // Plus
        ],
        subscriberLength: 6,
      },
    };
