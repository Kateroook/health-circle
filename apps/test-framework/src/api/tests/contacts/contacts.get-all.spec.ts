...
test.describe('/api/contacts get-all tests', async () => {
  ...
  test("[CNT-009] Successful get list of user's contacts", async ({ api }) => {
  ...
  test("[CNT-010] Presence of a new contact in a user's contact list", async ({ api }) => {
  ...
  test("[CNT-011] Get list of user's contacts without authorization", async ({ api }) => {
