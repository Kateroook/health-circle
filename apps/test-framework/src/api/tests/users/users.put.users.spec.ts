  ...
  async () => {
    [
      ...
      test(
        ...
        async ({ api, spawnUser, userRepository }) => {
    ...
    test(
      '[USR-040] Changing the phone to another user`s phone',
      {
        tag: '@smoke',
      },
      async ({ api, spawnUser }) => {
    ...
    test(
      '[USR-044] Request without id field',
      {
        tag: '@sanity',
      },
      async ({ api, spawnUser }) => {
    ...
    test(
      '[USR-045] Request without authorization (no token)',
      {
        tag: '@smoke',
      },
      async ({ api, spawnUser }) => {
