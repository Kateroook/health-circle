...
test.describe(
  ...
  async () => {
    ...
    test(
      '[AUTH-018] Successful password setup after registration',
      {
        tag: '@smoke',
      },
      async ({ api }) => {
    ...
    test(
      '[AUTH-019] Wrong confirmation code for password setup',
      {
        tag: '@smoke',
      },
      async ({ api }) => {
    ...
    test(
      "[AUTH-020] Passwords don't match in password setup",
      {
        tag: '@smoke',
      },
      async ({ api }) => {
    ...
    test(
      '[AUTH-027] Passwords setup with the same code twice',
      {
        tag: '@sanity',
      },
      async ({ api }) => {
    ...
    test(
      '[AUTH-028] Passwords setup with the old code',
      {
        tag: '@smoke',
      },
