        ...
        try {
            ...
            if (errorData && typeof errorData === "object" && Array.isArray(errorData.message)) {
                ...
                messages.forEach((msg: string) => {
                    ...
                    if (lowerMsg.includes("електрон") || lowerMsg.includes("пошт") || lowerMsg.includes("email")) {
                        newServerErrors.email = msg;
                    } else if (lowerMsg.includes("телефон") || lowerMsg.includes("номер") || lowerMsg.includes("phone")) {
