    ...
    >
      ...
      >
            ...
            <ScrollView style={{ maxHeight: 350 }}>
              {localMembers.map((m) => (
                ...
                >
                  ...
                  {m.active ? (
                    <AntDesign name="check-circle" size={22} color={COLORS.PRIMARY_BLUE} />
                  ) : (
                    <AntDesign name="close-circle" size={22} color={COLORS.TEXT_GRAY} />
                  )}
                </TouchableOpacity>
              ))}
            </ScrollView>
        ...
        {!isRenaming && !isEditingMembers && isViewingBlocked && isOwner && (
          <BlockedUsersView circleId={circleId} onClose={() => setIsViewingBlocked(false)} />
        )}
          ...
          <>
            ...
            {isOwner ? (
              <>
                ...
                <TouchableOpacity style={styles.item} onPress={() => setIsViewingBlocked(true)}>
