...
export default function Register() {
    ...
    const fields = [
        ...
        { key: "middleName", label: "По батькові", placeholder: "Введіть по батькові" },
        { key: "lastName", label: "Прізвище", placeholder: "Введіть прізвище" },
        { key: "phone", label: "Телефон", placeholder: "+380 XX XXX XX XX", keyboardType: "phone-pad" },
        { key: "email", label: "Email", placeholder: "example@mail.com", keyboardType: "email-address" },
    ];
