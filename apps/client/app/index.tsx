            ...
            <View style={styles.container}>
                ...
                <View style={styles.descriptionContainer}>
                    <Text style={styles.description}>
                        Одна кнопка для спокою. Будьте на зв'язку з близькими під час тривоги,
                        відстежуйте здоров'я і синхронізуйте графіки — навіть без інтернету.
                    </Text>
                    ...
                    <View style={styles.featuresContainer}>
                        <View style={styles.feature}>
                            ...
                            <Text style={styles.featureText}>SOS "Я в безпеці"</Text>
                        </View>
                        <View style={styles.feature}>
                            <Text style={styles.featureIcon}>💊</Text>
                            <Text style={styles.featureText}>Нагадування про здоров'я</Text>
                        </View>
                        <View style={styles.feature}>
                            <Text style={styles.featureIcon}>📅</Text>
