...
export class Sync1774372858185 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX "public"."IDX__logs_time"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_user_activities_user_id"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_user_passwords_created_at"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_user_passwords_user_id"`);
