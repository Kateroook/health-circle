...
export class AlterUserUniqueness1771007170534 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "confirmation_codes" ALTER COLUMN "type" TYPE "public"."confirmation_codes_type_enum" USING "type"::"text"::"public"."confirmation_codes_type_enum"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."confirmation_codes_type_enum_old" AS ENUM('REGISTRATION', 'PASSWORD_RESET', 'PASSWORD_EXPIRATION')`);
        await queryRunner.query(`ALTER TABLE "confirmation_codes" ALTER COLUMN "type" TYPE "public"."confirmation_codes_type_enum_old" USING "type"::"text"::"public"."confirmation_codes_type_enum_old"`);
